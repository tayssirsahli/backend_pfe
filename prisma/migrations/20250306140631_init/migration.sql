...
-- CreateEnum
CREATE TYPE "auth"."factor_status" AS ENUM ('ACTIVE', 'INACTIVE');

-- CreateEnum
CREATE TYPE "auth"."factor_type" AS ENUM ('SMS', 'EMAIL', 'APP');

-- CreateEnum
CREATE TYPE "auth"."one_time_token_type" AS ENUM ('confirmation_token', 'reauthentication_token', 'recovery_token', 'email_change_token_new', 'email_change_token_current', 'phone_change_token');

-- CreateEnum
CREATE TYPE "public"."verifier" AS ENUM ('planifée', 'publiée', 'Annuler');
...
-- CreateTable
CREATE TABLE "public"."generated_idea" (
    "id" UUID NOT NULL DEFAULT gen_random_uuid(),
    "generated_text" TEXT,
...
CREATE TABLE "public"."posts" (
    ...
    "temps" TIME(6),
    "user_id" UUID,
    "etat" "public"."verifier" DEFAULT 'planifée',
    "urls" TEXT[],
    "joints_urls" TEXT[],
...
-- AddForeignKey
ALTER TABLE "public"."error_log" ADD CONSTRAINT "error_log_usersId_fkey" FOREIGN KEY ("usersId") REFERENCES "auth"."users"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."generated_idea" ADD CONSTRAINT "generated_idea_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "public"."posts" ADD CONSTRAINT "posts_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
